...
%
% SYNTAX :
% [o_subCurEst] = gl_compute_subsurface_current(a_rawDataStruct, a_csvFilePathName)
%
% INPUT PARAMETERS :
...
%            Jean-Philippe Rannou (Capgemini) (jean.philippe.rannou@partenaire-exterieur.ifremer.fr)
% ------------------------------------------------------------------------------
% RELEASES :
%   02/08/2013 - Lucas Merckelbach - Version 0.1
%   09/12/2014 - RNU - matlab implementation from python code
% ------------------------------------------------------------------------------
function [o_subCurEst] = gl_compute_subsurface_current(a_rawDataStruct, a_csvFilePathName)
