...
if (isfield(a_sgStructure, 'ppca') && isfield(a_sgStructure.ppca, 'data') && isfield(a_sgStructure.ppca.data, 'time'))
   mergedTimes = [mergedTimes a_sgStructure.ppca.data.time];
end
if (isfield(a_sgStructure, 'ppcb') && isfield(a_sgStructure.ppcb, 'data') && isfield(a_sgStructure.ppcb.data, 'time'))
...
ctdDir = 'ab';
for idDir = 1:2
   if (isfield(a_sgStructure, (['ppc' ctdDir(idDir)])) && ...
         isfield(a_sgStructure.(['ppc' ctdDir(idDir)]), 'data') && ...
