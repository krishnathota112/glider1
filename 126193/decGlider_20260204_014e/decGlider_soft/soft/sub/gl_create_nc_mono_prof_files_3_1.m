...
%
% SYNTAX :
%  [o_generatedFiles] = gl_create_nc_mono_prof_files_3_1( ...
...
% ------------------------------------------------------------------------------
% RELEASES :
%   28/11/2022 - RNU - creation
% ------------------------------------------------------------------------------
function [o_generatedFiles] = gl_create_nc_mono_prof_files_3_1( ...
   a_tabProfiles, a_metaData, a_outputDirName, a_baseFileName)
...
for idProf = 1:length(a_tabProfiles)
   ...
   if (profInfo(idProf, 4) == 0)
      ...
      if (nbProfParam > 0)
         ...
         % end
         fCdf = netcdf.create(ncPathFileName, mode);
         if (isempty(fCdf))
         ...
         netcdf.putAtt(fCdf, globalVarId, 'title', 'Glider vertical profile');
         ...
         netcdf.putAtt(fCdf, globalVarId, 'references', sprintf('Generated by Coriolis EGO Glider decoder (version ''%s'')', g_decGl_decoderVersion));
         netcdf.putAtt(fCdf, globalVarId, 'comment', ' ');
         netcdf.putAtt(fCdf, globalVarId, 'user_manual_version', '1.11');
         netcdf.putAtt(fCdf, globalVarId, 'Conventions', 'EGO-2.0 CF-1.6');
         netcdf.putAtt(fCdf, globalVarId, 'featureType', 'trajectoryProfile');
         netcdf.putAtt(fCdf, globalVarId, 'decoder_version', sprintf('CODG_%s', g_decGl_decoderVersion));
         ...
         netcdf.putAtt(fCdf, dataTypeVarId, 'conventions', 'EGO reference table 1');
         ...
         netcdf.putAtt(fCdf, platformNumberVarId, 'long_name', 'Glider unique identifier');
         ...
         netcdf.putAtt(fCdf, stationParametersVarId, 'conventions', 'EGO reference table 3');
         netcdf.putAtt(fCdf, stationParametersVarId, '_FillValue', ' ');

         cycleNumberVarId = netcdf.defVar(fCdf, 'CYCLE_NUMBER', 'NC_INT', nProfDimId);
         netcdf.putAtt(fCdf, cycleNumberVarId, 'long_name', 'Glider descent or ascent number');
         netcdf.putAtt(fCdf, cycleNumberVarId, 'conventions', '1...N');
         ...
         netcdf.putAtt(fCdf, dataCenterVarId, 'long_name', 'Data centre in charge of glider data processing');
         netcdf.putAtt(fCdf, dataCenterVarId, 'conventions', 'EGO reference table 4');
         ...
         netcdf.putAtt(fCdf, dataStateIndicatorVarId, 'conventions', 'EGO reference table 5');
         ...
         netcdf.putAtt(fCdf, platformTypeVarId, 'long_name', 'Type of glider');
         netcdf.putAtt(fCdf, platformTypeVarId, 'conventions', 'EGO reference table 23');
         netcdf.putAtt(fCdf, platformTypeVarId, '_FillValue', ' ');

         gliderSerialNoVarId = netcdf.defVar(fCdf, 'GLIDER_SERIAL_NO', 'NC_CHAR', fliplr([nProfDimId string32DimId]));
         netcdf.putAtt(fCdf, gliderSerialNoVarId, 'long_name', 'Serial number of the glider');
         netcdf.putAtt(fCdf, gliderSerialNoVarId, '_FillValue', ' ');

         firmwareVersionVarId = netcdf.defVar(fCdf, 'FIRMWARE_VERSION', 'NC_CHAR', fliplr([nProfDimId string64DimId]));
         ...
         netcdf.putAtt(fCdf, wmoInstTypeVarId, 'conventions', 'EGO reference table 8');
         ...
         netcdf.putAtt(fCdf, juldVarId, 'resolution', double(1/86400)); % 1 second
         ...
         netcdf.putAtt(fCdf, juldQcVarId, 'conventions', 'EGO reference table 2.1');
         ...
         netcdf.putAtt(fCdf, juldLocationVarId, 'resolution', double(1/86400)); % 1 second
         ...
         netcdf.putAtt(fCdf, positionQcVarId, 'conventions', 'EGO reference table 2.1');
         ...
         for idParam = 1:length(profUniqueParamName)
            ...
            netcdf.putAtt(fCdf, profileParamQcVarId, 'conventions', 'EGO reference table 2.1a');
         ...
         netcdf.putAtt(fCdf, verticalSamplingSchemeVarId, 'conventions', 'EGO reference table 16');
         ...
         for idP = 1:nbProfInFile
            ...
            for idParam = 1:length(parameterList)
               ...
               if (~gl_var_is_present(fCdf, profParamName))
                  doubleType = 0;
                  if (strncmp(profParamName, 'CNT_IR', length('CNT_IR')) || ...
                        strcmp(profParamName, 'MTIME'))
                     doubleType = 1;
                     doubleTypeInFile = 1;
                  end
                  ...
                  % if (g_decGl_netCDFCompressionFlag)
                  %    netcdf.defVarDeflate(fCdf, profParamVarId, true, true, g_decGl_netCDFDeflateLevel);
                  % end
               ...
               if (~gl_var_is_present(fCdf, profParamQcName))
                  ...
                  % if (g_decGl_netCDFCompressionFlag)
                  %    netcdf.defVarDeflate(fCdf, profParamQcVarId, true, true, g_decGl_netCDFDeflateLevel);
                  % end
                  netcdf.putAtt(fCdf, profParamQcVarId, 'long_name', 'quality flag');
                  netcdf.putAtt(fCdf, profParamQcVarId, 'conventions', 'EGO reference table 2.1');
               ...
               if (~gl_var_is_present(fCdf, profParamAdjName))
                  ...
                  % if (g_decGl_netCDFCompressionFlag)
                  %    netcdf.defVarDeflate(fCdf, profParamAdjVarId, true, true, g_decGl_netCDFDeflateLevel);
                  % end
               ...
               if (~gl_var_is_present(fCdf, profParamAdjQcName))
                  ...
                  % if (g_decGl_netCDFCompressionFlag)
                  %    netcdf.defVarDeflate(fCdf, profParamAdjQcVarId, true, true, g_decGl_netCDFDeflateLevel);
                  % end
                  netcdf.putAtt(fCdf, profParamAdjQcVarId, 'long_name', 'quality flag');
                  netcdf.putAtt(fCdf, profParamAdjQcVarId, 'conventions', 'EGO reference table 2.1');
               ...
               if (~gl_var_is_present(fCdf, profParamAdjErrName))
                  ...
                  % if (g_decGl_netCDFCompressionFlag)
                  %    netcdf.defVarDeflate(fCdf, profParamAdjErrVarId, true, true, g_decGl_netCDFDeflateLevel);
                  % end
         ...
         netcdf.putAtt(fCdf, parameterVarId, 'conventions', 'EGO reference table 3');
         ...
         netcdf.putAtt(fCdf, historyInstitutionVarId, 'conventions', 'EGO reference table 4');
         ...
         netcdf.putAtt(fCdf, historyStepVarId, 'conventions', 'EGO reference table 12');
         ...
         netcdf.putAtt(fCdf, historyActionVarId, 'conventions', 'EGO reference table 7');
         ...
         netcdf.putAtt(fCdf, historyParameterVarId, 'conventions', 'EGO reference table 3');
         ...
         % create profile variables
         idVal = find(strcmp('PLATFORM_NUMBER', a_metaData));
         if (~isempty(idVal))
         ...
         idVal = find(strcmp('PROJECT_NAME', a_metaData));
         if (~isempty(idVal))
            valueStr = char(a_metaData{idVal+1});
         ...
         idVal = find(strcmp('PI_NAME', a_metaData));
         if (~isempty(idVal))
            valueStr = char(a_metaData{idVal+1});
            valueStr = [valueStr blanks(64-length(valueStr))];
            tabValue = repmat(valueStr, nbProfInFile, 1);
         ...
         for idP = 1:nbProfInFile
            ...
            for idParam = 1:length(parameterList)
               ...
               if (length(valueStr) > paramNameLength)
                  fprintf('ERROR: Glider #%d : NetCDF variable name %s too long (> %d) - name truncated\n', ...
                     g_decGl_floatNum, valueStr, paramNameLength);
         ...
         idVal = find(strcmp('DATA_CENTRE', a_metaData));
         if (~isempty(idVal))
            valueStr = char(a_metaData{idVal+1});
         ...
         idVal = find(strcmp('PLATFORM_TYPE', a_metaData));
         if (~isempty(idVal))
            valueStr = char(a_metaData{idVal+1});
         ...
         idVal = find(strcmp('GLIDER_SERIAL_NO', a_metaData));
         if (~isempty(idVal))
            valueStr = char(a_metaData{idVal+1});
            valueStr = [valueStr blanks(32-length(valueStr))];
            tabValue = repmat(valueStr, nbProfInFile, 1);
            netcdf.putVar(fCdf, gliderSerialNoVarId, permute(tabValue, fliplr(1:ndims(tabValue))));
         end

         idVal = find(strcmp('FIRMWARE_VERSION', a_metaData));
         if (~isempty(idVal))
            valueStr = char(a_metaData{idVal+1});
            valueStr = [valueStr blanks(64-length(valueStr))];
            tabValue = repmat(valueStr, nbProfInFile, 1);
         ...
         idVal = find(strcmp('WMO_INST_TYPE', a_metaData));
         if (~isempty(idVal))
            valueStr = char(a_metaData{idVal+1});
            valueStr = [valueStr blanks(4-length(valueStr))];
            tabValue = repmat(valueStr, nbProfInFile, 1);
               ...
               if ~((length(profParamName) > 9) && strcmp(profParamName(end-8:end), '_ADJUSTED'))
                  ...
                  if (nbProfSubLevels == 0)
                     ...
                     if (g_decGl_reportOnProfileFlag)
                        if ((idP == 1) && strcmp(profParamName, 'PRES'))
                           presVal = paramData(measIds);
                        end
                     end
                  else
         ...
         o_generatedFiles = [o_generatedFiles; ...
            [{ncPathFileName} {ncFileName} {prof.direction} {prof.date} {nbProfLevels} {presVal(1)} {presVal(end)} {prof.dates(1)} {prof.dates(end)}]];
