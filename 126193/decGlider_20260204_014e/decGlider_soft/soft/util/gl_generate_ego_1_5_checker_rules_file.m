% ------------------------------------------------------------------------------
% Generate the rules file to check the EGO 1.5 format with the Coriolis Java
% checker.
%
% SYNTAX :
%  gl_generate_ego_1_5_checker_rules_file
%
% INPUT PARAMETERS :
%
% OUTPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function gl_generate_ego_1_5_checker_rules_file
...
TEMPLATE_RULES_FILE_PATH_NAME = 'C:\Users\jprannou\_RNU\Glider\soft\util\ref_lists\EGO_V1.5_TEMPLATE_20250211.xml';
